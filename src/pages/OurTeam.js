    ...
    <div className="font-inter">
      ...
      <div id="TeamContainer" className=" Ajit flex gap-x-6 grow basis-[420px] mt-[13vh]">
        ...
        <div className="flex justify-center items-center">
          <div>
            <div id="name" className="text-xl">Ajit Khadka</div>
            <div id="Task" className=" mt-[10px] text-md font-light opacity-70">
        ...
        <div id="TeamContainer" className="palden flex gap-x-6 grow basis-[420px] mt-[13vh]">
        <div id="phto" className="h-[150px] w-[150px] flex justify-center items-center">
          <img className=" object-fill" src={Ajit} alt=""></img>
        </div>
        <div className="flex justify-center items-center">
          <div>
            <div id="name" className="text-xl">Palden Gastyo Lama</div>
            <div id="Task" className=" mt-[10px] text-md font-light opacity-70">
              Front-end Developer and UI
            </div>
            <div className="flex gap-x-3  mt-[15px]">
        ...
        <div id="TeamContainer" className="suman flex gap-x-6 grow basis-[420px] mt-[13vh]">
        <div id="phto" className="h-[150px] w-[150px] flex justify-center items-center">
          <img className=" object-fill" src={Ajit} alt=""></img>
        </div>
        <div className="flex justify-center items-center">
          <div>
            <div id="name" className="text-xl">Suman Shrestha</div>
            <div id="Task" className=" mt-[10px] text-md font-light opacity-70">
              Back-end Developer
            </div>
            <div className="flex gap-x-3  mt-[15px]">
        ...
        <div id="TeamContainer" className=" bishal flex gap-x-6 grow basis-[420px] mt-[13vh]">
        <div id="phto" className="h-[150px] w-[150px] flex justify-center items-center">
          <img className=" object-fill" src={Ajit} alt=""></img>
        </div>
        <div className="flex justify-center items-center">
          <div>
            <div id="name" className="text-xl">Bishal Shrestha</div>
            <div id="Task" className=" mt-[10px] text-md font-light opacity-70">
            Back-end Developer
            </div>
            <div className="flex gap-x-3  mt-[15px]">
